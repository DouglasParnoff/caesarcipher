...
public class RequestMessageDTO {
	...
	public static RequestMessageDTO getDTOFromModel(RequestMessage model) {
		RequestMessageDTO dto = new RequestMessageDTO();
		dto.setToken(model.getToken());
		dto.setCifrado(model.getEncoded());
		dto.setDecifrado(model.getDecoded());
		dto.setNumero_casas(model.getPositionsNumber());		
		dto.setResumo_criptografico(model.getSummary());
		return dto;
	}
